...
pub fn extract_types<'a>(spec: &'a KsySpec) -> BTreeMap<Vec<&'a String>, &'a TypeSpec> {
...
pub fn extract_type_types<'a>(type_spec: &'a TypeSpec) -> BTreeMap<Vec<&'a String>, &'a TypeSpec> {
    let mut map = BTreeMap::new();
